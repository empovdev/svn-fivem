...
Config.RadioChannelsWithName = {
    ...
    ["1"] = "Police General",                                   -- Every channels between 1 and 2 will be named "Police"
    ["2"] = "Police House Mart",                                   -- Every channels between 1 and 2 will be named "Police"
    ["3"] = "Police",                                   -- Every channels between 1 and 2 will be named "Police"
    ["4"] = "Police",                                   -- Every channels between 1 and 2 will be named "Police"
    ["5"] = "Police",                                   -- Every channels between 1 and 2 will be named "Police"
    ["6"] = "Police",                                   -- Every channels between 1 and 2 will be named "Police"
    ["7"] = "Police",                                   -- Every channels between 1 and 2 will be named "Police"
    ["8"] = "Police",                                   -- Every channels between 1 and 2 will be named "Police"
    ["9"] = "Police",                                   -- Every channels between 1 and 2 will be named "Police"
    ["10"] = "Ambulance",                                -- Every channels between 2 and 3 will be named "Ambulance"
    ["11"] = "Ambulance",                                -- Every channels between 2 and 3 will be named "Ambulance"
}
