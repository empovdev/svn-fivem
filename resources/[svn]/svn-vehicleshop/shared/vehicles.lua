...
VehiclesData = {
    ...
    { model = 'astron',        name = 'Astron',                        brand = 'Pfister',         price = 150000,  category = 'suvs',         type = 'automobile', shop = 'pdm' },
    { model = 'baller7',       name = 'Baller ST',                     brand = 'Gallivanter',     price = 145000,  category = 'suvs',         type = 'automobile', shop = 'pdm' },
    { model = 'baller8',       name = 'Baller ST 8',                   brand = 'Gallivanter',     price = 145000,  category = 'suvs',         type = 'automobile', shop = 'pdm' },
    ...
    --- Coupes (3)
    { model = 'comet7',        name = 'Comet',                         brand = 'S2 Cabrio',       price = 25000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    ...
    -- custom
    { model = 'svnc1',  name = 'GTR',                  brand = 'Vulcar',      price = 13000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'svnc2',  name = 'Skyline GTR R34',      brand = 'Vulcar',      price = 15000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'svnc3',  name = 'CX 30',                brand = 'Maibatsu',    price = 12000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'svnc4',  name = 'GT63S',                brand = 'Benefactor',  price = 20000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'svnc5',  name = 'AMG GT',               brand = 'Benefactor',  price = 18000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'svnc6',  name = 'ML63',                 brand = 'Benefactor',  price = 17000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'svnc7',  name = 'GT63S Special',        brand = 'Benefactor',  price = 22000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'svnc8',  name = 'M8',                   brand = 'Schyster',    price = 16000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'svnc9',  name = 'Dawn',                 brand = 'Enus',        price = 25000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'svnc10', name = 'M8 Animated',          brand = 'Schyster',    price = 17000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'svnc11', name = 'Q8',                   brand = 'Obey',        price = 14000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'svnc12', name = 'Huracine Animated',    brand = 'Pegassi',     price = 30000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'svnc13', name = 'Eclipse GSX',          brand = 'Karin',       price = 11000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'svnc14', name = 'Chiron Super Sport',   brand = 'Truffade',    price = 35000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'svnc15', name = 'Tundra',               brand = 'Annis',       price = 13000, category = 'custom',   type = 'automobile', shop = 'pdm' },
}
