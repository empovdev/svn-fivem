Config = {
    ...
    CommandPermission = 'admin', -- Permission level for add stock (god for QB, admin for ESX)
    VehicleShops = {
        {   
            ...
            EnableStocks = false,
            AllowedCategories = {"custom", "sedans", "sportsclassics", "offroad", "cycles", "motorcycles", "vans", "super", "sports", "coupes", "compacts", "suvs", "muscle"},
            Coords = {
