        ...
        Citizen.CreateThread(function()
            while true do
                ...
                if NetworkIsPlayerActive(PlayerId()) then
                    TriggerEvent('svn-spawn:client:openUI')
                    break
                end
            end
        end)
...
RegisterNetEvent('svn-spawn:client:openUI', function(value)
...
RegisterNetEvent('svn-spawn:client:setupSpawns', function(cData, new, apps)
    if not new then
        SendNUIMessage({
