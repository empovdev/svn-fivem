...
local function AdminMenu()
    QBCore.Functions.TriggerCallback('svn-radialmenu:checkPermission', function(result)
        if result == true then
            local AdminMenu = {
                id = 'admin',
                title = 'Admin',
                ...
                items = {
                    {
                        id = 'adminannounce',
                        title = 'Announce Admin',
                        icon = 'bullhorn',
                        type = 'client',
                        event = 'Debux:open:admin',
                        shouldClose = true
                    },
                    {
                        id = 'viewreports',
                        ...
                        icon = 'bug-slash',
                        type = 'client',
                        event = 'okokReports:client:xembaocao',
                        shouldClose = true
                    }
                }
            }
