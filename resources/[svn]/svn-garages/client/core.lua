...
function TriggerCallback(name, cb, ...)
    ...
    TriggerServerEvent('svn-garages:server:triggerCallback', name, ...)
end

RegisterNetEvent('svn-garages:client:triggerCallback', function(name, ...)
...
function GetVehiclesData(source)
    if CoreName == "qb-core" or CoreName == "qbx_core" then
        return Core.Shared.Vehicles
    elseif CoreName == "es_extended" then
        return Vehicles
    end
end
