...
window.addEventListener('message', function(event) {
    ...
    if (ed.action === "VehicleList") {
		...
		garageVehicles.forEach(function(vehData, index) {
			...
			let svg;
			if (useCarImg) {
				svg = `<img src="https://docs.fivem.net/vehicles/${vehData.vehicle}.webp" 
							style="width: 8vw; position: relative; padding-top: 2vw;" 
							onerror="this.onerror=null; this.src='files/car.png'; this.style.width='7vw';">`;
			} else {
