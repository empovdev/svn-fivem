local isDead = false
RegisterNetEvent('svn-deathscreen:openUI', function(time)
    isDead = true
...
RegisterNetEvent('svn-deathscreen:revive', function()
    isDead = false
...
RegisterNetEvent('svn-deathscreen:die', function(time)
    isDead = true
    SendNUIMessage({action = "DSMenu", open = true, time = time})
    if Config.Blur then
        TriggerScreenblurFadeIn()
...
RegisterNetEvent('svn-deathscreen:res', function()
    SendNUIMessage({action = "res"})
end)

RegisterNetEvent('svn-deathscreen:updateRes', function(time)
