...
$(".button-1").click(function () {
  ...
  $.post('https://svn-announce/close');
  var id = $(".input").val()
  $.post('https://svn-announce/button-1', JSON.stringify({
      id: id
  }));
});
...
$(".button-2").click(function () {
  ...
  $.post('https://svn-announce/close');
  var id = $(".input").val()
  $.post('https://svn-announce/button-2', JSON.stringify({
      id: id
  }));
});
...
$(".button-3").click(function () {
  ...
  $.post('https://svn-announce/button-3', JSON.stringify({
    id: id,
...
$(".button-4").click(function () {
  ...
  $.post('https://svn-announce/button-4', JSON.stringify({
    id: id,
    tarih: GetDateAndTime(),
}));
});
