...
Config.Discord = {
    ...
    ["ApplicationId"] = '1210857985564352533', -- The discord application id
    ["IconLarge"] = 'svn', -- The name of the large icon
    ["IconLargeHoverText"] = 'svn Server', -- The hover text of the large icon
    ["IconSmall"] = 'ico', -- The name of the small icon
    ...
    ["Buttons"] = {
        {
            text = 'Test Server!',
            url = 'https://discord.com/invite/2G96dasQPM'
        },
        {
            text = 'Buy Now!',
            url = 'https://buymeacoffee.com/svn/e/233890'
        }
    }
}
