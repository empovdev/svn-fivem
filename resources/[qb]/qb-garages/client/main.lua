            ...
            for _, v in pairs(result) do
                ...
                if type == "depot" and vname ~= nil then
                    ...
                    MenuGarageOptions[#MenuGarageOptions + 1] = {
                        ...
                        disabled = vname == nil,
                        params = {
                            event = "svn-garages:client:takeOutGarage",
                            args = {
                                vehicle = v,
                                type = type,
                                garage = garage,
...
RegisterNetEvent('svn-garages:client:takeOutGarage', function(data)
    local type = data.type
...
RegisterNetEvent('qb-garages:client:TakeOutDepot', function(data)
    ...
    if vehicle.depotprice ~= 0 then
        ...
        TriggerEvent("svn-garages:client:takeOutGarage", data)
    end
end)
