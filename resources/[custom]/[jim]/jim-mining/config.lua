...
------------------------------------------------------------
	SellItems = { -- Selling Prices
		...
		['emerald_necklace_silver'] = 350,
		['ruby_necklace_silver'] = 350,
		['sapphire_necklace_silver'] = 350,
...
--Mining Store Items
	Items = {
		...
		items = {
			{ name = "water_bottle", price = 50, amount = 50, info = {}, type = "item", slot = 1, },
			{ name = "sandwich", price = 50, amount = 50, info = {}, type = "item", slot = 2, },
			{ name = "bandage", price = 150, amount = 50, info = {}, type = "item", slot = 3, },
			{ name = "weapon_flashlight", price = 0, amount = 100, info = {}, type = "item", slot = 4, },
			{ name = "goldpan", price = 300, amount = 100, info = {}, type = "item", slot = 5, },
			...
			{ name = "drillbit", price = 10, amount = 100, info = {}, type = "item", slot = 9, },
		},
	},
}
Crafting = {
