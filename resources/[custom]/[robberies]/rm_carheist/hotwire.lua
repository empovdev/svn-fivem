...
setupScaleform = function(scaleform, message, button, message2, buttons, message3, button2)
...
StartHotwire = function(cb)
    ...
    drawTable = {
        ...
        {"mphotwire", "leftnode", {0.26, 0.285, func_1920(164.0) * aspectdividor, func_1080(56.0), 0.0}, 1},
        {"mphotwire", "leftnode", {0.26, 0.435, func_1920(164.0) * aspectdividor, func_1080(56.0), 0.0}, 2},
        {"mphotwire", "leftnode", {0.26, 0.585, func_1920(164.0) * aspectdividor, func_1080(56.0), 0.0}, 3},
        {"mphotwire", "leftnode", {0.26, 0.735, func_1920(164.0) * aspectdividor, func_1080(56.0), 0.0}, 4},
        {"mphotwire", "rightnode", {0.74, 0.285, func_1920(164.0) * aspectdividor, func_1080(56.0), 0.0}, 1},
        {"mphotwire", "rightnode", {0.74, 0.435, func_1920(164.0) * aspectdividor, func_1080(56.0), 0.0}, 2},
        {"mphotwire", "rightnode", {0.74, 0.585, func_1920(164.0) * aspectdividor, func_1080(56.0), 0.0}, 3},
        {"mphotwire", "rightnode", {0.74, 0.735, func_1920(164.0) * aspectdividor, func_1080(56.0), 0.0}, 4},
    }
    nodes = {
        [1] = {
    ...
    while minigameLoop do
        ...
        if win then
            func_drawtext("SUCCESS", 0.442, 0.5, 0.9, 68, 177, 148)
            time = time - 10
            if time <= 0 then
                func_reset()
                cb(true)
...
function func_1920(param0)
    return param0 / 1920.0
end

function func_1080(param0)
    return param0 / 1080.0
end

function func_drawtext(param0, param1, param2, param3, param4, param5, param6)
    BeginTextCommandDisplayText("STRING")
